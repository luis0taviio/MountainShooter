...
class Level:
    def __init__(self, window, name, game_mode):
        ...
        self.window = window
        self.name = name
        self.game_mode = game_mode  # vai definir o modo de jogo
        self.entity_list: list[Entity] = []
        self.entity_list.extend(EntityFactory.get_entity('Level1Bg'))
        self.entity_list.append(EntityFactory.get_entity('Player1'))
        if game_mode in [MENU_OPTION[1], MENU_OPTION[2]]:
            self.entity_list.append(EntityFactory.get_entity('Player2'))
        pygame.time.set_timer(EVENT_ENEMY, SPAWN_TIME)  # EVENTO SPAWNAR OS INIMIGOS
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.level_text(14, f'fps: {clock.get_fps() : .0f}', COLOR_WHITE,
                            (10, WIN_HEIGHT - 35))  # mostrar o fps do game na tela
